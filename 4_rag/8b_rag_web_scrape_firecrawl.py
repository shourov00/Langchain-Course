...
def create_vector_store():
    ...
    loader = FireCrawlLoader(
        api_key=api_key, url="https://www.apple.com/shop/buy-mac/macbook-pro", mode="scrape")
    docs = loader.load()
...
query = ("Which MacBook would be the best choice for handling multiple heavy web projects, working with AI models and "
         "LLMs, while also supporting three external monitors?")
